...
class TestChartColors:
    ...
    def test_get_core_color_wraps(self, core_index):
        """Test core color wraps through the palette."""
        ...
        assert ChartColors.get_core_color(core_index + palette_size) == color
...
class TestCPUGraphApp:
    ...
    def test_calculate_history_points_examples(
        self, history_secs, interval_ms, expected
    ):
        """Test history point calculation examples."""
